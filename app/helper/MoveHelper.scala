...
class MoveHelper extends Constants{
 ...
 def getMove(opponentLastMoves :  List[String], myLastMoves :  List[String], opponentInfo: rbsinfo): String = {
   ...
   val randomNumber = if(myDynamite<opponentInfo.dynamiteCount && opponentLastMoves.size > (opponentInfo.maxRounds*0.75)) {1 + Random.nextInt(2)} else {2 + Random.nextInt(2)};
  ...
  private def lasNtLost(opponentLastMoves :  List[String], myLastMoves :  List[String], opponentInfo: rbsinfo, myDynamite: Int): String ={
    opponentLastMoves match {
      ...
      case _::ROCK::ROCK::PAPER::Nil  if(myLastMoves.takeRight(3) == List(SCISSORS,SCISSORS,ROCK)) => Random.shuffle(List(PAPER, SCISSORS)).head
      case _::ROCK::ROCK::SCISSORS::Nil  if(myLastMoves.takeRight(3) == List(SCISSORS,SCISSORS,PAPER)) => Random.shuffle(List(SCISSORS, ROCK)).head

      case _::ROCK::PAPER::ROCK::Nil  if(myLastMoves.takeRight(3) == List(SCISSORS,ROCK,SCISSORS)) => Random.shuffle(List(ROCK, PAPER)).head
      ...
      case _::ROCK::SCISSORS::ROCK::Nil  if(myLastMoves.takeRight(3) == List(SCISSORS,PAPER,SCISSORS)) => Random.shuffle(List(PAPER, ROCK)).head
      ...
      case _::PAPER::SCISSORS::PAPER::Nil  if(myLastMoves.takeRight(3) == List(ROCK,PAPER,ROCK)) => Random.shuffle(List(PAPER, SCISSORS)).head
      ...
      case _::SCISSORS::ROCK::SCISSORS::Nil  if(myLastMoves.takeRight(3) == List(PAPER,SCISSORS,PAPER)) => Random.shuffle(List(SCISSORS, ROCK)).head
      ...
      case _::SCISSORS::SCISSORS::ROCK::Nil  if(myLastMoves.takeRight(3) == List(PAPER,PAPER,SCISSORS)) => Random.shuffle(List(PAPER, ROCK)).head
      ...
      case _::ROCK::SCISSORS::Nil  if(myLastMoves.takeRight(2) == List(SCISSORS,PAPER)) => Random.shuffle(List(SCISSORS, ROCK)).head

      case _::PAPER::ROCK::Nil  if(myLastMoves.takeRight(2) == List(ROCK,SCISSORS)) => Random.shuffle(List(ROCK, PAPER)).head
      ...
      case _::SCISSORS::ROCK::Nil  if(myLastMoves.takeRight(2) == List(PAPER,SCISSORS)) => Random.shuffle(List(PAPER, ROCK)).head
      case _::SCISSORS::PAPER::Nil  if(myLastMoves.takeRight(2) == List(PAPER,ROCK)) => Random.shuffle(List(PAPER, SCISSORS)).head
