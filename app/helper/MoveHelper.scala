...
class MoveHelper extends Constants{
 ...
 def getMove(opponentLastMoves :  List[String], myLastMoves :  List[String], opponentInfo: rbsinfo): String = {
   ...
   val randomNumber = if(myDynamite<opponentInfo.dynamiteCount && opponentLastMoves.size > (opponentInfo.maxRounds*0.8)) {2 + Random.nextInt(2)} else {2 + Random.nextInt(3)};
  ...
  private def lasNtLost(opponentLastMoves :  List[String], myLastMoves :  List[String], opponentInfo: rbsinfo, myDynamite: Int): String ={
    opponentLastMoves match {
      ...
      case _::ROCK::ROCK::ROCK::Nil  if(myLastMoves.takeRight(3) == List(SCISSORS,SCISSORS,SCISSORS)) => Random.shuffle(List(PAPER, SCISSORS)).head
      ...
      case _::ROCK::PAPER::PAPER::Nil  if(myLastMoves.takeRight(3) == List(SCISSORS,ROCK, ROCK)) => Random.shuffle(List(SCISSORS, ROCK)).head
      ...
      case _::ROCK::SCISSORS::ROCK::Nil  if(myLastMoves.takeRight(3) == List(SCISSORS,PAPER,SCISSORS)) => Random.shuffle(List(ROCK, PAPER, SCISSORS)).head
      ...
      case _::ROCK::SCISSORS::SCISSORS::Nil  if(myLastMoves.takeRight(3) == List(SCISSORS,PAPER,PAPER)) => Random.shuffle(List(ROCK, PAPER)).head

      case _::PAPER::ROCK::ROCK::Nil  if(myLastMoves.takeRight(3) == List(ROCK,SCISSORS,SCISSORS)) => Random.shuffle(List(ROCK, PAPER)).head
      case _::PAPER::ROCK::PAPER::Nil  if(myLastMoves.takeRight(3) == List(ROCK,SCISSORS,ROCK)) => Random.shuffle(List(ROCK, PAPER)).head
      ...
      case _::PAPER::PAPER::PAPER::Nil  if(myLastMoves.takeRight(3) == List(ROCK,ROCK,ROCK)) => Random.shuffle(List(ROCK, PAPER)).head
      case _::PAPER::PAPER::SCISSORS::Nil  if(myLastMoves.takeRight(3) == List(ROCK,ROCK,PAPER)) => Random.shuffle(List(ROCK, PAPER)).head
      ...
      case _::PAPER::SCISSORS::PAPER::Nil  if(myLastMoves.takeRight(3) == List(ROCK,PAPER,ROCK)) => Random.shuffle(List(ROCK, PAPER)).head
      case _::PAPER::SCISSORS::SCISSORS::Nil  if(myLastMoves.takeRight(3) == List(ROCK,PAPER,PAPER)) => Random.shuffle(List(ROCK, PAPER)).head

      case _::SCISSORS::ROCK::ROCK::Nil  if(myLastMoves.takeRight(3) == List(PAPER,SCISSORS,SCISSORS)) => Random.shuffle(List(ROCK, PAPER)).head
      ...
      case _::SCISSORS::PAPER::PAPER::Nil  if(myLastMoves.takeRight(3) == List(PAPER,ROCK,ROCK)) => Random.shuffle(List(ROCK, PAPER)).head
      case _::SCISSORS::PAPER::SCISSORS::Nil  if(myLastMoves.takeRight(3) == List(PAPER,ROCK,PAPER)) => Random.shuffle(List(ROCK, PAPER)).head
      case _::SCISSORS::SCISSORS::ROCK::Nil  if(myLastMoves.takeRight(3) == List(PAPER,PAPER,SCISSORS)) => Random.shuffle(List(ROCK, PAPER)).head
      case _::SCISSORS::SCISSORS::PAPER::Nil  if(myLastMoves.takeRight(3) == List(PAPER,PAPER,ROCK)) => Random.shuffle(List(ROCK, PAPER)).head
  ...
  private def getLastTwoSameMove(opponentLastMoves :  List[String]): String = {
    ...
    opponentLastMoves.takeRight(2) match {
      case List(ROCK,ROCK) => Random.shuffle(List(ROCK, PAPER)).head
      ...
      case List(SCISSORS,ROCK) => Random.shuffle(List(ROCK, PAPER)).head
      case List(SCISSORS,PAPER) => Random.shuffle(List(PAPER, SCISSORS)).head
      case List(SCISSORS,SCISSORS) => Random.shuffle(List(SCISSORS, ROCK)).head
      case _ => getDefaultMove()
    }
  }
  ...
  private def getLastThreeSameMove(opponentLastMoves :  List[String]): String = {
    ...
    opponentLastMoves.takeRight(3) match {
      ...
      case List(ROCK,PAPER,SCISSORS) => Random.shuffle(List(SCISSORS, ROCK)).head
      case List(ROCK,SCISSORS,ROCK) => Random.shuffle(List(ROCK, SCISSORS)).head
      ...
      case List(PAPER,ROCK,SCISSORS) => Random.shuffle(List(ROCK, PAPER)).head
      ...
      case List(PAPER,SCISSORS,ROCK) => Random.shuffle(List(ROCK, PAPER)).head
      ...
      case List(SCISSORS,ROCK,PAPER) => Random.shuffle(List(PAPER, SCISSORS)).head
      case List(SCISSORS,ROCK,SCISSORS) => Random.shuffle(List(SCISSORS, ROCK)).head
      case List(SCISSORS,PAPER,ROCK) => Random.shuffle(List(ROCK, PAPER)).head
